...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1462: x0 => x0.abort(),
      _1463: () => new AbortController(),
      _1464: x0 => x0.getReader(),
      _1465: x0 => x0.read(),
      _1466: x0 => x0.cancel(),
      _1497: (s, m) => {
        try {
      ...
      _1564: Function.prototype.call.bind(BigInt.prototype.toString),
      _1565: Function.prototype.call.bind(Number.prototype.toString),
      _1566: (d, digits) => d.toFixed(digits),
      _1569: (d, precision) => d.toPrecision(precision),
      _1570: () => globalThis.document,
      _1590: x0 => x0.src,
      _1591: (x0,x1) => x0.src = x1,
      _1592: x0 => x0.naturalWidth,
      _1593: x0 => x0.naturalHeight,
      _1609: x0 => x0.status,
      _1610: (x0,x1) => x0.responseType = x1,
      _1612: x0 => x0.response,
      _3441: () => globalThis.window,
      _3503: x0 => x0.navigator,
      _3892: x0 => x0.userAgent,
      _6035: x0 => x0.signal,
      _6107: () => globalThis.document,
      _7867: x0 => x0.value,
      _7869: x0 => x0.done,
      _8560: x0 => x0.url,
      _8562: x0 => x0.status,
...
"subscription",
"Provide input for your flow.",
"Input",
"_Direction.",
"Starting flow with input: ",
...
"Error starting flow ",
"http://localhost:8080/start/playground_flow",
"Error creating flow: ",
"Error creating flow",
...
"Description",
"A simple description of the module.",
"Triggers",
"A comma-separated list of triggers for the module.",
"Input Template",
...
"Select a module to add it to the flow.",
"Modules",

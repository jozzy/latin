...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1388: (a, i) => a.push(i),
      _1389: (a, i) => a.splice(i, 1)[0],
      _1391: (a, l) => a.length = l,
      _1392: a => a.pop(),
      _1393: (a, i) => a.splice(i, 1),
      _1394: (a, s) => a.join(s),
      _1395: (a, s, e) => a.slice(s, e),
      _1396: (a, s, e) => a.splice(s, e),
      ...
      _1478: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1479: (x0,x1) => globalThis.fetch(x0,x1),
      _1480: (x0,x1) => x0.get(x1),
      _1481: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1481(f,arguments.length,x0,x1,x2) }),
      _1482: (x0,x1) => x0.forEach(x1),
      _1483: x0 => x0.abort(),
      _1484: () => new AbortController(),
      _1485: x0 => x0.getReader(),
      _1486: x0 => x0.read(),
      _1487: x0 => x0.cancel(),
      _1518: (s, m) => {
        try {
      ...
      _1590: (d, precision) => d.toPrecision(precision),
      _1591: () => globalThis.document,
      _1597: (x0,x1) => { x0.height = x1 },
      _1599: (x0,x1) => { x0.width = x1 },
      _1608: x0 => x0.style,
      _1611: x0 => x0.src,
      _1612: (x0,x1) => { x0.src = x1 },
      _1613: x0 => x0.naturalWidth,
      _1614: x0 => x0.naturalHeight,
      _1630: x0 => x0.status,
      _1631: (x0,x1) => { x0.responseType = x1 },
      _1633: x0 => x0.response,
      _3462: () => globalThis.window,
      _3524: x0 => x0.navigator,
      _3913: x0 => x0.userAgent,
      _6056: x0 => x0.signal,
